...
//study hours are between 8am and 5pm
    ...
    public static String schedulemaker(String button_day){
        ...
        schema.append(make_training_string(training_frequency, training_time, button_day));
    ...
    private static StringBuilder make_training_string(int frequency, int[] time, String day){
        StringBuilder temp= new StringBuilder();
        if((frequency==1) && day.equals("Sat")){
            temp.append(make_training_substring(time, day));
    ...
    private static StringBuilder make_training_substring(int[] time, String day){
        StringBuilder temp= new StringBuilder();
